...
const CodePage = () => {
    ...
    return (
        <div>
            <Heading
                title="PhDBot Code Generation"
                description="PhDBot can help you with code for analysis and automation."
                icon={Code}
                                    ...
                                    <FormItem className="col-span-12 mt-4 ">
                                        ...
                                        <FormControl className="m-0 p-0">
                                            <Input
                                                ...
                                                disabled={isLoading}
                                                placeholder="Decribe what you want the code to perform."
                                                {...field}
                                            />
                                        </FormControl>
                                    </FormItem>
